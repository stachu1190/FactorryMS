...
def delivery_parser():
    parser = reqparse.RequestParser()
    parser.add_argument("date_delivery", type=str, help="Date in format YYYY-MM-DD", required=True)
    parser.add_argument("id_supplier", type=int, help="ID of the supplier who delivered ordered supplies", required=True)
